...
<body>client/
    ...
    <!-- Hero Start -->
    <jsp:include page="../layout/bannerUnderHeader.jsp"/>
    <!-- Hero End -->
    ...
    <!-- Fruits Shop Start-->
    <jsp:include page="../layout/allProduct.jsp"/>
    <!-- Fruits Shop End-->
    ...
    <!-- <jsp:include page="../layout/bannerSection.jsp"/> -->
   
    <!-- Banner Section End -->


    <!-- Bestsaler Product Start -->
    <jsp:include page="../layout/bestSeller.jsp"/>
    <!-- Bestsaler Product End -->


    <!-- Fact Start -->
    <jsp:include page="../layout/fact.jsp"/>
    <!-- Fact Start -->


    <!-- Tastimonial Start -->
    <jsp:include page="../layout/tastimonal.jsp"/>
    <!-- Tastimonial End -->
